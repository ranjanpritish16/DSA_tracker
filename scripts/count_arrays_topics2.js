...
// Find the array start after the '=' sign (skip the "Problem[]" type brackets)
const eq = text.indexOf('=', m);
if (eq === -1) { console.error('= not found after marker'); process.exit(1); }
...
console.log('slice start', start, 'end', end, 'length', body.length);
console.log('preview head:', body.slice(0,200));
console.log('preview tail:', body.slice(-200));
let rows;
